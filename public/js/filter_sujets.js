    // get all of our list items
            var itemsToFilter = document.querySelectorAll(".cluster");
              
            //setup click event handlers on our checkboxes
            var checkBoxes = document.querySelectorAll(".filterSection li div input");
            ...
            function hideOrShowItems(itemType, classToRemove, classToAdd) {
                for (var i = 0; i < itemsToFilter.length; i++) {
					...
					if(currentItem.getAttribute("data-type") != null){
						if (currentItem.getAttribute("data-type").includes(itemType)) {
